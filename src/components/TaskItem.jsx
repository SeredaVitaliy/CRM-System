    ...
    <li className="tasks">
      ...
      <div style={{ display: "flex" }}>
        {isEdit ? (
          ...
          <button className="btn btn-edit" onClick={handleEditClick}>
            ...
            >
              ...
              />
              <path
                d="M16 12.9998V15.9998C16 16.5303 15.7893 17.039 15.4142 17.414C15.0391 17.7891 14.5304 17.9998 14 17.9998H3C2.46957 17.9998 1.96086 17.7891 1.58579 17.414C1.21071 17.039 1 16.5303 1 15.9998V4.99983C1 4.4694 1.21071 3.96069 1.58579 3.58562C1.96086 3.21055 2.46957 2.99983 3 2.99983H6"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        {isEdit ? (
          ...
          <button className="btn btn-del" onClick={() => onDeleteTask(task.id)}>
            <svg
              width="15"
              height="15"
              viewBox="0 0 16 18"
